...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mirror Pods Frequency Tagging Pilot
% UCL, initiated 18/04/2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
layout_path         = [toolsPath 'LandauLab_64Ch_Layout.mat'];

expdir              = [yoelpath 'Pilots\MirrorPods_FrequencyTagging_Pilot\'];
analysis_dir        = [expdir 'Analysis\'];
datadir             = [expdir 'data\'];
...
env.data.rawFiles        = dir(fullfile(env.paths.rawData, '**', ['*' fileTyp]));
